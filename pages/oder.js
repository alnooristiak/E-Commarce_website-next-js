                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Oder ID:<span className='text-indigo-600'> #0809jhj89#$%#%</span> </h1>
                            <div class="flex mb-4">
                            ...
                            <div className="flex border-t border-gray-200 py-2">
                                <span className="text-gray-500">huddy</span>
                                <span className="ml-auto text-gray-900">1</span>
                            </div>
                            <div className="flex border-t border-b mb-6 border-gray-200 py-2">
                                <span className="text-gray-500">stiker</span>
                                <span className="ml-auto text-gray-900">1</span>
                            </div>
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900">{subTotal}</span>
                                <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Trac Oder</button>
